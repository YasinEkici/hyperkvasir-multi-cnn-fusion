...
olmuş; donmuş final model bu yapılandırmanın TTA'lı sürümüdür (havuzlanmış
...
CE şampiyonunu istatistiksel olarak geçememiştir; bu, mimarinin bu protokoldeki
tavanına yakın olduğunu gösterir. Kalan açığın başlıca kaynağı, çok düşük destekli
...
İleride, donmuş model üzerinde yorumlanabilirlik analizleri --- Grad-CAM++
