...
yapılandırma üzerinde Week 3.5 toplamsal ablasyonlarının dürüst baş-başa
...
\subsection{Week 3.5 Toplamsal Ablasyonlar: Dürüst Baş-Başa Karşılaştırma}
\label{subsec:week35}
...
\begin{table}[H]
\centering
\caption{En iyi yapılandırma (exp 11) üzerinde Week 3.5 ablasyonları, havuzlanmış
