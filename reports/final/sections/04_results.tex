...
Donmuş final model (exp 11 + TTA) için bu değerler biraz daha yüksektir: Kappa
...
\caption{Donmuş final model (exp 11 + TTA) için $23\times23$ satır-normalize hata
...
\caption{Donmuş final model için sınıf-bazlı F1 (azalan sırada; kırmızı sütunlar:
...
ark.~\cite{borgli2020hyperkvasir} baseline'larıyla donmuş final modelimizi
