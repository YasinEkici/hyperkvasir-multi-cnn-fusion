...
![](assets/figures/_page_0_Figure_3.jpeg)
...
Following [20], we build FPN on top of the ResNet architecture [16]. We construct a pyramid with levels P$^{3}$ through P7, where $l$ indicates pyramid level (P$^{l}$ has resolution 2$^l$ lower than the input). As in [20] all pyramid levels have C = 256 channels. Details of the pyramid generally follow [20] with a few modest differences.[2](#page-3-0) While many design choices are not crucial, we emphasize the use of the FPN backbone is; preliminary experiments using features from only the final ResNet layer yielded low AP.

Anchors: We use translation-invariant anchor boxes similar to those in the RPN variant in [20]. The anchors have areas of 32$^2$ to 512$^2$ on pyramid levels P$^{3}$ to P7, respectively. As in [20], at each pyramid level we use anchors at three aspect ratios {1:2, 1:1, 2:1}. For denser scale coverage than in [20], at each level we add anchors of sizes {2$^0$, 2$^{1/3}$, 2$^{2/3}$} of the original set of 3 aspect ratio anchors. This improve AP in our setting. In total there are A = 9 anchors per level and across levels they cover the scale range 32 - 813 pixels with respect to the network's input image.
...
|------|--------------|---------|------|-----------|-----------|
| CE   | _            | _       | 31.1 | 49.4      | 33.0      |
| FL   | 2.0          | _       | 34.0 | 52.5      | 36.5      |
| FL*  | 2.0          |         | 33.8 | 52.7      | 36.3      |
...
$$p_{\mathsf{t}}^* = \sigma(\gamma x_{\mathsf{t}} + \beta),\tag{7}$$

$$FL^* = -\log(p_t^*)/\gamma. \tag{8}$$
...
![](assets/figures/_page_8_Figure_14.jpeg)

Figure 6. Derivates of the loss functions from Figure 5 w.r.t. x.

![](assets/figures/_page_8_Figure_16.jpeg)
...
$$\frac{d\text{FL}}{dx} = y(1 - p_{t})^{\gamma} (\gamma p_{t} \log(p_{t}) + p_{t} - 1) \tag{10}$$
...
- [1] S. Bell, C. L. Zitnick, K. Bala, and R. Girshick. Insideoutside net: Detecting objects in context with skip pooling and recurrent neural networks. In *CVPR*, 2016. [6](#page-5-6)
- [2] S. R. Bulo, G. Neuhold, and P. Kontschieder. Loss maxpooling for semantic image segmentation. In *CVPR*, 2017. [3](#page-2-3)
- [3] J. Dai, Y. Li, K. He, and J. Sun. R-FCN: Object detection via region-based fully convolutional networks. In *NIPS*, 2016. [1](#page-0-2)
- [4] N. Dalal and B. Triggs. Histograms of oriented gradients for human detection. In *CVPR*, 2005. [2](#page-1-0)
- [5] P. Dollar, Z. Tu, P. Perona, and S. Belongie. Integral channel ´ features. In *BMVC*, 2009. [2,](#page-1-0) [3](#page-2-3)
- [6] D. Erhan, C. Szegedy, A. Toshev, and D. Anguelov. Scalable object detection using deep neural networks. In *CVPR*, 2014. [2](#page-1-0)
- [7] M. Everingham, L. Van Gool, C. K. Williams, J. Winn, and A. Zisserman. The PASCAL Visual Object Classes (VOC) Challenge. *IJCV*, 2010. [2](#page-1-0)
- [8] P. F. Felzenszwalb, R. B. Girshick, and D. McAllester. Cascade object detection with deformable part models. In *CVPR*, 2010. [2,](#page-1-0) [3](#page-2-3)
- [9] C.-Y. Fu, W. Liu, A. Ranga, A. Tyagi, and A. C. Berg. DSSD: Deconvolutional single shot detector. *arXiv:1701.06659*, 2016. [1,](#page-0-2) [2,](#page-1-0) [8](#page-7-1)
- [10] R. Girshick. Fast R-CNN. In *ICCV*, 2015. [1,](#page-0-2) [2,](#page-1-0) [4,](#page-3-2) [6,](#page-5-6) [8](#page-7-1)
- [11] R. Girshick, J. Donahue, T. Darrell, and J. Malik. Rich feature hierarchies for accurate object detection and semantic segmentation. In *CVPR*, 2014. [1,](#page-0-2) [2,](#page-1-0) [5](#page-4-2)
- [12] R. Girshick, I. Radosavovic, G. Gkioxari, P. Dollar, ´ and K. He. Detectron. [https://github.com/](https://github.com/facebookresearch/detectron) [facebookresearch/detectron](https://github.com/facebookresearch/detectron), 2018. [8](#page-7-1)
- [13] T. Hastie, R. Tibshirani, and J. Friedman. *The elements of statistical learning*. Springer series in statistics Springer, Berlin, 2008. [3,](#page-2-3) [7](#page-6-1)
- [14] K. He, G. Gkioxari, P. Dollar, and R. Girshick. Mask R- ´ CNN. In *ICCV*, 2017. [1,](#page-0-2) [2,](#page-1-0) [4](#page-3-2)
- [15] K. He, X. Zhang, S. Ren, and J. Sun. Spatial pyramid pooling in deep convolutional networks for visual recognition. In *ECCV*. 2014. [2](#page-1-0)
- [16] K. He, X. Zhang, S. Ren, and J. Sun. Deep residual learning for image recognition. In *CVPR*, 2016. [2,](#page-1-0) [4,](#page-3-2) [5,](#page-4-2) [6,](#page-5-6) [8](#page-7-1)
- [17] J. Huang, V. Rathod, C. Sun, M. Zhu, A. Korattikara, A. Fathi, I. Fischer, Z. Wojna, Y. Song, S. Guadarrama, and K. Murphy. Speed/accuracy trade-offs for modern convolutional object detectors. In *CVPR*, 2017. [2,](#page-1-0) [8](#page-7-1)
- [18] A. Krizhevsky, I. Sutskever, and G. Hinton. ImageNet classification with deep convolutional neural networks. In *NIPS*, 2012. [2](#page-1-0)
- [19] Y. LeCun, B. Boser, J. S. Denker, D. Henderson, R. E. Howard, W. Hubbard, and L. D. Jackel. Backpropagation applied to handwritten zip code recognition. *Neural computation*, 1989. [2](#page-1-0)
- [20] T.-Y. Lin, P. Dollar, R. Girshick, K. He, B. Hariharan, and ´ S. Belongie. Feature pyramid networks for object detection. In *CVPR*, 2017. [1,](#page-0-2) [2,](#page-1-0) [4,](#page-3-2) [5,](#page-4-2) [6,](#page-5-6) [8](#page-7-1)

- [21] T.-Y. Lin, M. Maire, S. Belongie, J. Hays, P. Perona, D. Ramanan, P. Dollar, and C. L. Zitnick. Microsoft COCO: Com- ´ mon objects in context. In *ECCV*, 2014. [1,](#page-0-2) [6](#page-5-6)
- [22] W. Liu, D. Anguelov, D. Erhan, C. Szegedy, and S. Reed. SSD: Single shot multibox detector. In *ECCV*, 2016. [1,](#page-0-2) [2,](#page-1-0) [3,](#page-2-3) [6,](#page-5-6) [7,](#page-6-1) [8](#page-7-1)
- [23] J. Long, E. Shelhamer, and T. Darrell. Fully convolutional networks for semantic segmentation. In *CVPR*, 2015. [4](#page-3-2)
- [24] P. O. Pinheiro, R. Collobert, and P. Dollar. Learning to segment object candidates. In *NIPS*, 2015. [2,](#page-1-0) [4](#page-3-2)
- [25] P. O. Pinheiro, T.-Y. Lin, R. Collobert, and P. Dollar. Learn- ´ ing to refine object segments. In *ECCV*, 2016. [2](#page-1-0)
- [26] J. Redmon, S. Divvala, R. Girshick, and A. Farhadi. You only look once: Unified, real-time object detection. In *CVPR*, 2016. [1,](#page-0-2) [2](#page-1-0)
- [27] J. Redmon and A. Farhadi. YOLO9000: Better, faster, stronger. In *CVPR*, 2017. [1,](#page-0-2) [2,](#page-1-0) [8](#page-7-1)
- [28] S. Ren, K. He, R. Girshick, and J. Sun. Faster R-CNN: Towards real-time object detection with region proposal networks. In *NIPS*, 2015. [1,](#page-0-2) [2,](#page-1-0) [4,](#page-3-2) [5,](#page-4-2) [8](#page-7-1)
- [29] H. Rowley, S. Baluja, and T. Kanade. Human face detection in visual scenes. Technical Report CMU-CS-95-158R, Carnegie Mellon University, 1995. [2](#page-1-0)
- [30] P. Sermanet, D. Eigen, X. Zhang, M. Mathieu, R. Fergus, and Y. LeCun. Overfeat: Integrated recognition, localization and detection using convolutional networks. In *ICLR*, 2014. [2](#page-1-0)
- [31] A. Shrivastava, A. Gupta, and R. Girshick. Training regionbased object detectors with online hard example mining. In *CVPR*, 2016. [2,](#page-1-0) [3,](#page-2-3) [6,](#page-5-6) [7](#page-6-1)
- [32] A. Shrivastava, R. Sukthankar, J. Malik, and A. Gupta. Beyond skip connections: Top-down modulation for object detection. *arXiv:1612.06851*, 2016. [2,](#page-1-0) [8](#page-7-1)
- [33] K.-K. Sung and T. Poggio. Learning and Example Selection for Object and Pattern Detection. In *MIT A.I. Memo No. 1521*, 1994. [2,](#page-1-0) [3](#page-2-3)
- [34] C. Szegedy, S. Ioffe, V. Vanhoucke, and A. A. Alemi. Inception-v4, inception-resnet and the impact of residual connections on learning. In *AAAI Conference on Artificial Intelligence*, 2017. [8](#page-7-1)
- [35] J. R. Uijlings, K. E. van de Sande, T. Gevers, and A. W. Smeulders. Selective search for object recognition. *IJCV*, 2013. [2,](#page-1-0) [4](#page-3-2)
- [36] R. Vaillant, C. Monrocq, and Y. LeCun. Original approach for the localisation of objects in images. *IEE Proc. on Vision, Image, and Signal Processing*, 1994. [2](#page-1-0)
- [37] P. Viola and M. Jones. Rapid object detection using a boosted cascade of simple features. In *CVPR*, 2001. [2,](#page-1-0) [3](#page-2-3)
- [38] S. Xie, R. Girshick, P. Dollar, Z. Tu, and K. He. Aggregated ´ residual transformations for deep neural networks. In *CVPR*, 2017. [8](#page-7-1)
- [39] C. L. Zitnick and P. Dollar. Edge boxes: Locating object ´ proposals from edges. In *ECCV*, 2014. [2](#page-1-0)